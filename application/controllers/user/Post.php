...
class Post extends CI_Controller
{
	...
	public function index()
	{
		...
		$usr = $this->auth_model->current_user()->username;
		$data['articles'] = $this->article_model->find_by_user($usr);
		...
		$this->load->view('user/post_list.php', $data);
		}
	}
	...
	public function new()
	{
		...
		$this->load->view('user/post_new_form.php', $data);
	}
	...
	public function edit($id = null)
	{
		...
		if ($this->input->method() === 'post') {
			...
			if ($updated) {
				$this->session->set_flashdata('message', 'Materi Berhasil Dirubah');
				redirect('user/post');
			}
		}

		$this->load->view('user/post_edit_form.php', $data);
	}
